...
export default function Dashboard() {
  ...
  const stats = role === "client"
    ...
    : [
        ...
        { label: "Total Listings", value: projects.length,     color: "#22d3ee", bg: "rgba(34,211,238,0.1)"  },
...
const s = {
  ...
  main: {
    flex: 1,
    overflowY: "auto",
    background: "radial-gradient(ellipse at 10% 10%, rgba(108,99,255,0.07) 0%, transparent 55%), radial-gradient(ellipse at 90% 90%, rgba(244,114,182,0.05) 0%, transparent 55%), #07080f",
  },
  inner: {
    padding: "44px 52px",
    maxWidth: 1100,
